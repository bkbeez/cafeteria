...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content modal-manage">
        <form name="RecordForm" action="<?=$form?>/address_saving.php" method="POST" enctype="multipart/form-data" class="form-manage" target="_blank">
                    ...
                    <div class="row gx-1">
                        ...
                        <div class="col-xs-8 col-sm-4 col-md-4 col-lg-4">
                            <div class="form-floating form-select-wrapper mb-1">
                                ...
                                <label for="zipcode"><?=Lang::get('ZipCode')?> <span class="text-red">*</span></label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            success: function(rs) {
                ...
                if(data.status=='success'){
                    ...
                    $("form[name='RecordForm'] .modal-footer").fadeOut(1000, function(){
                        $(".card-profile .set-shop-address").html(data.display);
