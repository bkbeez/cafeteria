    ...
    <div class="modal-content modal-manage">
        <form name="RecordForm" action="<?=$form?>/name_saving.php" method="POST" enctype="multipart/form-data" class="form-manage" target="_blank">
            ...
            <div class="modal-header">
                ...
                <h2 class="mb-0 text-primary text-start on-text-oneline"><i class="uil uil-edit" style="float:left;font-size:36px;line-height:36px;margin-right:3px;"></i><?=Lang::get('Shop')?></h2>
            </div>
            ...
            success: function(rs) {
                ...
                if(data.status=='success'){
                    ...
                    $("form[name='RecordForm'] .modal-footer").fadeOut(1000, function(){
                        $(".card-profile .set-shop-name").html(data.display);
