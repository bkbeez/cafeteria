...
<style type="text/css">
    ...
    .shop-menu-list .card .uil.uil-custom {
        color: white;
        font-size:52px;
        line-height:24px;
    }
        ...
        <div class="row">
            ...
            <?php if( $shop_id ){ ?>
                <div class="card card-profile">
                    <div class="row gx-0">
                        <div class="col-lg-6 image-wrapper bg-image bg-cover rounded-top rounded-lg-start d-md-block" data-image-src="<?=THEME_IMG?>/shop.png">
                            <div class="text-center mt-5">
                                <mark class="fs-36 text-dark on-bold-primary"><?=((isset($shop['shop_name'])&&$shop['shop_name'])?$shop['shop_name']:'-')?></mark>
                            </div>
                        </div>
                        <div class="col-lg-6">
