            ...
            <div class="modal-body">
                <div class="alert alert-primary alert-icon mb-2">
                    ...
                    <div class="form-floating mb-1">
                        <input id="shop_name" name="shop_name" value="" type="text" class="form-control" placeholder="...">
                    ...
                    <div class="row gx-1">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 mx-auto">
                            <div class="form-check mb-2">
                                <input id="status_1" class="form-check-input" type="radio" name="status_id" value="1" checked>
                                <label for="status_1" class="form-check-label form-payslip-select text-dark"><?=( (App::lang()=='en') ? 'Available' : 'พร้อมใช้งาน' )?></label>
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 mx-auto">
                            <div class="form-check mb-2">
                                <input id="status_2" class="form-check-input" type="radio" name="status_id" value="2">
