                    ...
                    <div class="row gx-1">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            <div class="form-floating form-select-wrapper mb-1">
                                <select id="shop_id" name="shop_id" class="form-select" aria-label="..."><?=Shop::getOptionAll(((isset($data['shop_id'])&&$data['shop_id'])?$data['shop_id']:null), '<option value="">'.Lang::get('Empty').'...</option>')?></select>
