<?php // Auto load Config, Library and Models
    ...
    session_start();
    // Environment
    if( file_exists($_SERVER["DOCUMENT_ROOT"].'/app/install/.env') ){
        $config = explode("\n", file_get_contents($_SERVER["DOCUMENT_ROOT"].'/app/install/.env'));
    ...
    define('APP_CODE', 'EDU CAFETERIA');
    define('APP_NAME_TH', 'ระบบบริหารจัดการร้านค้า');
    define('APP_NAME_EN', 'Shop Management System');
