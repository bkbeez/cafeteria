                ...
                $htmls .= '<div class="offcanvas-body d-flex flex-column">';
                    ...
                    if( Auth::admin() ){
                        $htmls .= '<div class="position-relative lift mt-2" onclick="document.location=\''.APP_HOME.'/admin/?users\'" style="cursor:pointer;">';
                            ...
                            $htmls .= '</div>';
                        $htmls .= '</div>';
                        $htmls .= '<div class="position-relative lift mt-2" onclick="document.location=\''.APP_HOME.'/admin/?sessions\'" style="cursor:pointer;">';
                            ...
                            $htmls .= '<div class="card">';
                                $htmls .= '<div class="card-body text-navy" style="height:72px;padding:12px 0 0 12px;">';
                                    ...
                                    $htmls .= '</div>';
                                    $htmls .= '<font style="line-height:48px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">'.( (App::lang()=='en') ? 'User Sessions' : 'ข้อมูลผู้ใช้ระบบ' ).'</font>';
                                $htmls .= '</div>';
                            $htmls .= '</div>';
                        $htmls .= '</div>';
