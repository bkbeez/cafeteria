...
class Mail {
    ...
    static function getTemplate($template='default')
    {
        ...
        $_LOGO_  = '<div style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">';
            $_LOGO_ .= '';
            $_LOGO_ .= '<b style="color:#2576bb;font-size:42px;font-family:sans-serif;">EDU </b>';
            $_LOGO_ .= '<b style="color:#fec655;font-size:42px;font-family:sans-serif;">C</b>';
            $_LOGO_ .= '<b style="color:#36ba8b;font-size:42px;font-family:sans-serif;">A</b>';
            $_LOGO_ .= '<b style="color:#f68878;font-size:42px;font-family:sans-serif;">F</b>';
            $_LOGO_ .= '<b style="color:#2576bb;font-size:42px;font-family:sans-serif;">E</b>';
            $_LOGO_ .= '<b style="color:#2576bb;font-size:42px;font-family:sans-serif;">T</b>';
            $_LOGO_ .= '<b style="color:#fec655;font-size:42px;font-family:sans-serif;">E</b>';
            $_LOGO_ .= '<b style="color:#36ba8b;font-size:42px;font-family:sans-serif;">R</b>';
            $_LOGO_ .= '<b style="color:#f68878;font-size:42px;font-family:sans-serif;">I</b>';
            $_LOGO_ .= '<b style="color:#f66678;font-size:42px;font-family:sans-serif;">A</b>';
        $_LOGO_ .= '</div>';
